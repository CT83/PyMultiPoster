...
def publish_update_company_page(message="", title="", company_id=""):
    import requests
    auth = "AQVwWpDvP_2FTR5hvTHRXNbMKlWh5sK9BDVJmKG_fzAnKKgoT6bLDrZy0z3kN-RQa2e36evsfTMMlw4gq5BwlQiBbWUq7JIZAxALCssZ4nPPdeKFlEfnehh8Qqw87_eu6-ulyVPdWEsgS-zAxpNQPRW5IlJ2tQ56Lk_jGMlnnVowikarEfCs4VIqBo1GxP8YouYpefmwK_Yebelp-VFeRCpNJ3Nx1dAeLn3d5cRNyXE8nrvDYfqxSSQrtWewiNz1u9QUS-2wmOrLXjfJSfUuOM-stOi4Cbzcnrsh9xljamU9SKj-WjGQLFjfFEMqY-K3_-4aEAODYdzto-3rIAAzV6i6YInb4w"
...
def main():
    ...
    publish_update_company_page(message="Test Message", title="Title Message", company_id="13691092")
